...
class NativeBridgePlugin(private val activity: Activity): Plugin(activity) {
    ...
    private var redirectScheme = "readup"
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        when (intent.action) {
            Intent.ACTION_VIEW -> {
                // "Open with Readup": the OS hands us a single content://
            ...
            Intent.ACTION_SEND -> {
                // System share-sheet → "Send to Readup" (single file).
        ...
        pluginScope.launch {
            val ret = withContext(Dispatchers.IO) {
                ...
                try {
                    ...
                    val album = args.albumName ?: "Readup"
