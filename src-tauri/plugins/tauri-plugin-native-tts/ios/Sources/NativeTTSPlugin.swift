...
private let keepAliveLog = Logger(subsystem: "cc.readup", category: "TTSKeepAlive")
...
class NativeTTSPlugin: Plugin, AVSpeechSynthesizerDelegate {
  ...
  @objc public func update_carplay_state(_ invoke: Invoke) {
    do {
      ...
      defaults.set(active, forKey: "readup.carplay.active")
      defaults.set(args.title ?? "", forKey: "readup.carplay.title")
      defaults.set(args.author ?? "", forKey: "readup.carplay.author")
      DispatchQueue.main.async {
        NotificationCenter.default.post(
          name: Notification.Name("readupCarPlayStateChanged"), object: nil)
      }
      invoke.resolve()
    } catch {
  ...
  private func claimAudioSession() {
    ...
    NotificationCenter.default.post(
      name: Notification.Name("ReadupTTSAudioSessionClaimed"), object: nil)
  }
  ...
  private func deactivateRemoteCommands() {
    ...
    NotificationCenter.default.post(
      name: Notification.Name("ReadupTTSAudioSessionReleased"), object: nil)
