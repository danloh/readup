...
const SCROLL_WRAPPER_TOUCH_SCROLL_FLAG = 'data-reader-scroll-wrapper-touch-scroll';
...
/**
 * Capture-phase touch + wheel routing so foliate's paginator and reader's wheel
...
export const applyTableTouchScroll = (document: Document) => {
  ...
  // foliate has no wheel handler, but reader forwards iframe wheel events to
