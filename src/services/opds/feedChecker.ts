...
import { resolveURL,looksLikeXMLContent,parseOPDSXML } from '@/app/catalog/utils/opdsUtils';
import { normalizeOPDSCustomHeaders } from '@/app/catalog/utils/customHeaders';
 ...
 * 2. Drop formats Reader cannot import — downloading them only to fail at
