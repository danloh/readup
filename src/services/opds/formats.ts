...
import { parseMediaType } from '@/app/catalog/utils/opdsUtils';
...
// Media types that positively identify a document Reader cannot import.
...
// Ebook formats Reader cannot open, distinctive enough to match anywhere in a
 ...
 *
 * Unlike getFormatExt this also names formats Reader cannot import, so a menu
...
/**
 * Whether Reader can import what this acquisition link points at.
 *
...
/**
 * Rank a link by how well Reader reads the format:
...
/** The link Reader would rather download, by format tier then feed order. */
