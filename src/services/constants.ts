...
export const DOWNLOAD_READUP_URL = 'https://readup.ccc?utm_source=readup_web';

export const READUP_WEB_BASE_URL = 'https://web.readup.cc';

export const GITHUB_LATEST_DOWNLOAD = '';

export const READUP_UPDATER_FILE = `${GITHUB_LATEST_DOWNLOAD}/latest.json`;

export const READUP_CHANGELOG_FILE = `${GITHUB_LATEST_DOWNLOAD}/release-notes.json`;
