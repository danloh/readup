...
const colorPanelItems = [
  ...
  {
    id: 'settings.color.invertImageColors',
    labelKey: _('Invert Image Colors'),
    keywords: ['invert', 'image', 'photo'],
    section: 'Theme',
  },
  {
  ...
  },
  {
    ...
    keywords: ['tts', 'highlight', 'color', 'style', 'speech', 'read', 'aloud'],
    section: 'Highlight',
  },
  {
...
const aiPanelItems = [
  ...
  {
    id: 'settings.ai.TestConnection',
    labelKey: _('Test Connection'),
    keywords: ['test', 'model', 'connection'],
    section: 'AI',
  },
];
...
const actionItems = [
  ...
  {
    id: 'action.about',
    labelKey: _('About Readup'),
    keywords: ['about', 'readup', 'version', 'info'],
  },
  {
    id: 'action.telemetry',
    labelKey: _('Help improve Readup'),
