      ...
      >
        <div className='flex flex-col gap-6 p-4'>
          <div className='not-eink:text-gray-400 flex items-center gap-1 text-xs'>
            <span className='not-eink:text-yellow-300 flex-1 line-clamp-1 select-text break-words font-medium'>
              &quot;{selection?.text || ''}&quot;
            </span>
            {onManage && (
              <button
        ...
        <div className='flex flex-1 items-center justify-between gap-2 p-4'>
          ...
          <Select
            className='not-eink:bg-gray-600 eink:bg-base-100 not-eink:text-white'
            value={scope}
