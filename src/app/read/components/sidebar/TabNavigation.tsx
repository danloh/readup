    ...
    >
      {tabs.map((tab) => (
        <div
          ...
          role='button'
          className={clsx(
            'tooltip tooltip-top z-20 m-1 flex-1 cursor-pointer rounded-lg p-2 transition-colors duration-200',
            activeTab === tab && 'bg-base-300/85',
          )}
          data-tip={getTabLabel(tab)}
        ...
        >
          <div className='m-0 flex h-6 items-center p-0'>
            {tab === 'toc' ? (
              ...
              <PiFeatherDuotone className='mx-auto' />
            ) : tab === 'bookmarks' ? (
