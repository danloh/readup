...
const SideBar: React.FC<{
  ...
  const { sideBarBookKey, setSideBarBookKey, setSearchTerm, clearSearch } = useSidebarStore();
  const { isSearchBarVisible, setSearchBarVisible, getSearchNavState } = useSidebarStore();
