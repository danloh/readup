...
import { TbCircle, TbCircleX } from "react-icons/tb";
...
import { Column, Id, Card, KanbanData } from "../utils/types";
  ...
  return (
    <div className="flex flex-row items-center justify-between m-1">
      ...
      {colors.map((color, index) => (
        ...
        ><TbCircle size={24} fill={color} /></button>
      ))}
      <input 
        type="color" 
