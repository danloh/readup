  ...
  useEffect(() => {
    ...
    const renderError = (word: string) => {
      ...
      p.innerHTML = _('Unable to load the word. Try searching directly on {{link}}.', {
        link: `<a href="https://en.wiktionary.org/w/index.php?search=${encodeURIComponent(word)}" target="_blank" rel="noopener noreferrer" class="not-eink:text-primary underline">Wiktionary</a>`,
      });
