...
import { PIN_LENGTH, generatePinSalt, hashPin, isValidPin, verifyPin } from '@/libs/applock';
...
export default function AppLockDialog() {
  ...
  const description =
    mode === 'set'
      ? _(
          'Pick a 4-digit PIN. You will need to enter it every time you open Readup. There is no way to recover a forgotten PIN — clearing the app data is the only way to reset it.',
        )
      : mode === 'change'
