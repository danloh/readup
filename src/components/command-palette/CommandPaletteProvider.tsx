...
export const CommandPaletteProvider: React.FC<CommandPaletteProviderProps> = ({ children }) => {
  ...
  const { settings, setFontLayoutSettingsDialogOpen, setActiveSettingsItemId } = useSettingsStore();
  ...
  const openSettingsPanel = useCallback(
    ...
    [setFontLayoutSettingsDialogOpen, setActiveSettingsItemId],
  );
  ...
  }, [toggle, setFontLayoutSettingsDialogOpen]);
