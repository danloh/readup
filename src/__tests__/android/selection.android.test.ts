...
// fixture's exact text. Runs against any adb device/emulator with app
...
if (!env) {
  console.warn('[test:android] no adb device with app installed — skipping the Android lane');
}
