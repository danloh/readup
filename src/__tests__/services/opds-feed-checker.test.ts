...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <entry>
    ...
    // issue #5583: a Calibre entry that also carries KFX must not have
    // that picked over the EPUB sitting next to it.
    it('prefers EPUB over a format cannot import', () => {
      const pub: OPDSPublication = {
    ...
    it('skips an entry whose only formats are ones cannot import', () => {
      const pub: OPDSPublication = {
