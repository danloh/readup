...
describe('WebAppService', () => {
  ...
  describe('resolvePath', () => {
    test('resolves Data base dir', () => {
      ...
      expect(resolved.fp).toBe('Readup/test.json');
