...
/**
 * Regression guard: iOS Files preview/share sheet lost Reader for `.txt`
 ...
 * iOS stopped offering Reader as a `.txt` handler.
 *
...
describe('txt file association (iOS share sheet lost Reader for .txt)', () => {
