...
// A copy of the annotation note parser in units/md below.
// the options are mirrored here instead. Every behaviour case below
...
const BOOKNOTE_ITEM = 'src/app/read/components/sidebar/BooknoteItem.tsx';
