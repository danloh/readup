...
describe('handleA11yNavigation', () => {
  ...
  afterEach(() => {
    ...
    const existing = document.getElementById('readup-skip-link');
  ...
  test('creates skip link with correct attributes', () => {
    ...
    const skipLink = document.getElementById('readup-skip-link');
  ...
  test('does not duplicate skip link if already exists', () => {
    ...
    const skipLinks = document.querySelectorAll('#readup-skip-link');
