...
// The hook must catch it and surface a toast instead.
const h = vi.hoisted(() => ({
...
import useBooksManager from '@/app/read/hooks/useBooksManager';
...
describe('useBooksManager open-failure handling', () => {
  ...
  it('toasts instead of leaking an unhandled rejection when the book is missing', async () => {
