...
import { PublicationView } from '@/app/catalog/components/PublicationView';
import { DropdownProvider } from '@/context/DropdownContext';
import { parsePublicationDocument } from '@/app/catalog/utils/opdsPublication';
...
describe('PublicationView', () => {
  ...
  it('renders an HTML description (OPDS 2.0 JSON) as markup, not literal tags', () => {
    ...
    // render as markup, not show literal <p>/<strong> tags ( issue #4749).
  ...
  // End-to-end for issue #4749: a feed lists this book with only a
  ...
  describe('download format selection', () => {
    ...
    it('hides formats cannot import, collapsing to a one-click download', () => {
