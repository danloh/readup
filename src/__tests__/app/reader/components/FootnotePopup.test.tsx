...
vi.mock('@/app/read/utils/transientHighlight', () => ({
  showTransientHighlight: hoisted.showTransientHighlight,
}));

vi.mock('@/app/read/utils/annotatorUtil', () => ({
  drawAnnotationOverlay: vi.fn(),
}));

vi.mock('@/app/read/utils/footnoteHeuristics', () => ({
...
const renderPopup = async () => {
  ...
  const { default: FootnotePopup } = await import('@/app/read/components/FootnotePopup');
