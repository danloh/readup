...
vi.mock('@/app/read/utils/annotatorUtil', async () => {
  const actual = await vi.importActual<typeof import('@/app/read/utils/annotatorUtil')>(
    '@/app/read/utils/annotatorUtil',
  );
  return { ...actual, getHandlePositionsFromRange: () => null };
});

import { NOTE_PREFIX } from '@/types/view';
import { useAnnotationEditor } from '@/app/read/hooks/useAnnotationEditor';
