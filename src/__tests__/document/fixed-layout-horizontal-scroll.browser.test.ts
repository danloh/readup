...
// Horizontal scroll mode (#4995): pages joined at their left/right
...
describe('fixed-layout horizontal scroll mode (#4995)', () => {
  ...
  // Regression coverage for #4727 in horizontal mode: the iframe wheel
