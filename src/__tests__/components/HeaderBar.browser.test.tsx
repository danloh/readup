...
import HeaderBar from '@/app/read/components/HeaderBar';
import SectionInfo from '@/app/read/components/SectionInfo';
...
vi.mock('@/app/read/hooks/useSpatialNavigation', () => ({ useSpatialNavigation: () => {} }));
...
vi.mock('@/app/read/components/SidebarToggler', () => ({
  default: () => <button type='button'>sidebar-toggler</button>,
}));
vi.mock('@/app/read/components/BookmarkToggler', () => ({ default: () => null }));
vi.mock('@/app/read/components/NotebookToggler', () => ({ default: () => null }));
vi.mock('@/app/read/components/TranslationToggler', () => ({ default: () => null }));
vi.mock('@/app/read/components/ViewMenu', () => ({ default: () => null }));
vi.mock('@/app/read/components/SyncInfoDialog', () => ({ default: () => null }));
