...
describe('paragraph mode highlights (#6200)', () => {
  ...
  it('paints the highlights that fall in the focused paragraph onto the clone', async () => {
    ...
    expect(painted()).toEqual([
      { name: 'readup-annotation-highlight-facc15', texts: ['brave'], inClone: true },
      { name: 'readup-annotation-underline-f87171', texts: ['world'], inClone: true },
    ]);
    // Each painted style/colour gets its own ::highlight() rule.
    const css = container.querySelector('style')!.textContent!;
    expect(css).toContain('::highlight(readup-annotation-highlight-facc15)');
    expect(css).toContain('#facc15');
    expect(css).toContain('::highlight(readup-annotation-underline-f87171)');
